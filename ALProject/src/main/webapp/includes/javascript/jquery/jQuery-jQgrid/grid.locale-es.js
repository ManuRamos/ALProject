...
$.jgrid = {
	...
	search : {
	    ...
	    Find: "Buscar",
	    Reset: "Limpiar",
	    odata : ['igual ', 'no igual a', 'menor que', 'menor o igual que','mayor que','mayor o igual a', 'empiece por','no empiece por','esté en','no esté en','termina por','no termina por','contiene','no contiene'],
